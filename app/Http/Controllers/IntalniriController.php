...
class IntalniriController extends Controller
{
    public function index(){
      $gatherings = Meeting::withTranslations()->orderBy('created_at','desc')->get();
      $gatherings = $gatherings->translate(\App::getLocale(), 'ro');
    $ani = Meeting::select('ani')->orderBy('ani','desc')->get();
    $ani=$ani->toArray();
